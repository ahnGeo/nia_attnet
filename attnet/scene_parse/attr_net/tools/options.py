...
class TestOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--basketball_test_img_dir', default='/local_datasets/detectron2/basketball/jpg', type=str)
        self.parser.add_argument('--basketball_test_ann_path', default='/data/ahngeo11/nia/attnet/annotations/basketball_obj.json', type=str)
        self.is_train = False
